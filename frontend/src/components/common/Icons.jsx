...
export function QrCodeIcon({ className = "w-5 h-5" }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v1m6 11h2m-6 0h-2v4m0-6h3m-3 3h3m-3 3h3m-6-6h-3m-3 0H4m0 4h3m-3 0h3m-3 3h3m-3 0h3m3-12V4h6v6h-6zm0 12v-6h6v6h-6zm-12-12V4h6v6H4zm0 12v-6h6v6H4z" />
    </svg>
  );
}
...
export function BuildingIcon({ className = "w-5 h-5" }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5m0 0h5m-5 0V11m0 0h5m-5 0h-5" />
    </svg>
  );
}
