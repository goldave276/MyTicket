...
export default function StatCard({ title, value, icon: Icon, trend, color = 'indigo' }) {
  ...
  return (
    <div className="rounded-3xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-6 shadow-sm flex items-center justify-between">
      <div>
        <span className="text-xs font-bold uppercase tracking-wider text-zinc-500 dark:text-zinc-400">
          {title}
        </span>
        <h4 className="text-2xl font-black text-zinc-900 dark:text-white mt-1">{value}</h4>
